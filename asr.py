...
def _clear_gpu_cache() -> None:
    """Giải phóng CUDA memory nếu torch đã được nạp — import torch LAZY để
    stage 'asr' không vô tình kéo theo toàn bộ stack torch nặng khi chỉ dùng
    CPU/cloud (đúng tinh thần cài theo backend trong requirements-asr.txt)."""
    try:
        import torch
    except ImportError:
        return
